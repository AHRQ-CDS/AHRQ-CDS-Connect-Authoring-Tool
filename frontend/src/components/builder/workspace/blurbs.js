export const blurbs = {
  ...
  subpopulations: {
    ...
    link: 'documentation#Subpopulations'
  },
  baseElements: {
    blurb:
    ...
    link: 'documentation#Base_Elements'
  },
  recommendations: {
    blurb:
    ...
    link: 'documentation#Recommendations'
  },
  parameters: {
    blurb:

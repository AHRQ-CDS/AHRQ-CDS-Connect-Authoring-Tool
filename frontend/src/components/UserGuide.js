            ...
            <div className="h2-wrapper">
              ...
              <div className="h3-wrapper">
                ...
                <div className="h4-wrapper">
                  ...
                  <div>
                    ...
                    You can review a value set's contents by clicking on the eye icon{' '}
                    <FontAwesomeIcon icon={faEye} aria-hidden="true" />
                    {' '}to the right of the listed value set. You can delete the value set association by clicking the "X"
              ...
              <div className="h3-wrapper">
                ...
                <div>
                  ...
                  <FontAwesomeIcon icon={faAngleDoubleDown} aria-hidden="true" />
                  {' '}between the indent button and the delete button in the element's box. To re-expand an element, click
                  the double-right arrow{' '}
                  <FontAwesomeIcon icon={faAngleDoubleRight} aria-hidden="true" />
                  {' '}between the indent button and the delete button in the element's box.
                </div>
              </div>
              ...
              <div className="h3-wrapper">
                ...
                <div className="h4-wrapper">
                  ...
                  <div>
                    ...
                    Then click on the "indent" button{' '}
                    <FontAwesomeIcon icon={faIndent} aria-hidden="true" />
                    {' '}to the right of the element name to automatically create a new indented group and place the element in
                    it. This new group can (and should) be given a unique name. To add more elements in the group, use the new
                    "Add element" box that is displayed at the bottom of the indent group.
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    back to the outer indent level. Use the "outdent" button{' '}
                    <FontAwesomeIcon icon={faOutdent} aria-hidden="true" />
                    {' '}to outdent groups.
                  </div>
                </div>
              ...
              <div className="h3-wrapper">
                ...
                <div className="h4-wrapper">
                  ...
                  <div>
                    ...
                    using the "Base Element" label. If you click the link icon{' '}
                    <FontAwesomeIcon icon={faLink} className="delete-valueset-button" aria-hidden="true" />
                    {' '}to the far right of the base element's name, you will go directly to the base element definition.
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    If you click the link icon{' '}
                    <FontAwesomeIcon icon={faLink} className="delete-valueset-button" aria-hidden="true" />
                    {' '}to the far right of the use's elementname, you will go directly to the element's definition.
                  </div>
                  <div>
              ...
              <div className="h3-wrapper">
                ...
                <div className="h4-wrapper">
                  ...
                  <div>
                    ...
                    recommendations with this in mind. To re-order recommendations, click the up arrow{' '}
                    <FontAwesomeIcon icon={faCaretUp} aria-hidden="true" />
                    {' '}or down arrow{' '}
                    <FontAwesomeIcon icon={faCaretDown} aria-hidden="true" />
                    {' '}on any recommendation to move it up or down.
                  </div>
                  <div>
                    <img
                      alt=""
              ...
              <div className="h3-wrapper">
                ...
                <div className="h4-wrapper">
                  ...
                  <div>
                    ...
                    icon{' '}
                    <FontAwesomeIcon icon={faLink} className="delete-valueset-button" aria-hidden="true" />
                    {' '}to the far right of the parameter's name, you will go directly to the parameter definition.
                  </div>
                  <div>
            ...
            <div className="h2-wrapper">
              ...
              <div className="h3-wrapper">
                ...
                <div>
                  ...
                  {' '}(respectively). When expanded, each group shows a table with the most relevant data for that type
                  (e.g., conditions show onset and abatement, medications show date written, etc.).
                </div>
                <div>
              ...
              <div className="h3-wrapper">
                ...
                <div>
                  ...
                  <FontAwesomeIcon icon={faChevronDown} aria-hidden="true" />
                  {' '}to the right of the patient you want to view results for.
                </div>
                <div>
                  <img
                    alt=""
                ...
                <div>
                  ...
                  <ul>
                    <li>
                      ...
                      <FontAwesomeIcon icon={faCheck} className="boolean-check" aria-hidden="true" />
                      {' '}indicates the patient met the inclusion criteria, a red "X"{' '}
                      <FontAwesomeIcon icon={faTimes} className="boolean-x" aria-hidden="true" />
                      {' '}indicates the patient did not meet the inclusion criteria, and the phrase "No Value" indicates that
                      there was not enough data to make a determination.
                    </li>
                    <li>
                      <strong>MeetsExclusionCriteria</strong>: A green checkmark{' '}
                      <FontAwesomeIcon icon={faCheck} aria-hidden="true" />
                      {' '}indicates the patient met the exclusion criteria, a red "X"{' '}
                      <FontAwesomeIcon icon={faTimes} className="boolean-x" aria-hidden="true" />

  ...
  return (
    <div className={clsx(styles.guide, 'toc-container')} id="maincontent">
      ...
      <div className={clsx(styles.tocWrapper, 'toc-wrapper')}>
        ...
        <p>
          Note: <code>Convert</code> refers to the CDS Connect Conversions library. Any functions used from this library
          will be automatically embedded into the artifact's primary CQL library.
        </p>
          ...
          <div className={styles.h3Wrapper}>
            ...
            <ul>
              <li>
                ...
                <ul>
                  <li>
                    CQL operator: <code>is null</code> or <code>is not null</code>
                  </li>
                  <li>
                    Summary: Checks if the current element is or is not <code>null</code>. In CQL, <code>null</code> is
                    used to indicate that something is absent or has an unknown value.
                  </li>
          ...
          <div className={styles.h3Wrapper}>
            ...
            <ul>
              ...
              <li>
                ...
                <ul>
                  <li>
                    CQL operator: <code>exists</code>
                  </li>
                  <li>
                    Summary: Checks if the list contains at least one item. If the list contains at least one item, it
            ...
            <ul>
              <li>
                ...
                <ul>
                  <li>
                    CQL function: <code>C3F.ActiveOrConfirmedAllergyIntolerance</code>
                  </li>
                  <li>
                  ...
                  <li>Returns: List of Allergy Intolerances</li>
                </ul>
              </li>
              <li>
            ...
            <ul>
              <li>
                ...
                <ul>
                  <li>
                    CQL function: <code>AllTrue</code>
                  </li>
                  <li>
                    Summary: Checks if every item in the list is <code>true</code>. If so, it returns <code>true</code>.
                    Otherwise (if any item is not <code>true</code>), it returns <code>false</code>.
                  </li>
                  <li>Returns: Boolean</li>
                </ul>
              </li>
              <li>
                ...
                <ul>
                  <li>
                    CQL function: <code>AnyTrue</code>
                  </li>
                  <li>
            ...
            <ul>
                  ...
                  <li>
                    ...
                    <ul>
                      <li>
                        ...
                        <code>abatement[x]</code> 'null'
                      </li>
                      <li>
                        In FHIR STU3 and DSTU2, this returns conditions with <code>clinicalStatus</code> 'active' or{' '}
                        <code>abatement[x]</code> 'null' or 'not true'
                      </li>
                    </ul>
                  </li>
              ...
              <li>
                ...
                <ul>
                  <li>
                    CQL function: <code>C3F.ActiveOrRecurring</code>
                  </li>
                  <li>
                    Summary: Returns a list of conditions with <code>clinicalStatus</code> indicating active, recurring,
                    or relapse
                    <ul>
                      <li>
                        In FHIR R4, this returns conditions with <code>clinicalStatus</code> 'active' or 'recurrence' or
                        'relapse'
                      </li>
                      <li>
                        In FHIR STU3 and DSTU2, this returns conditions with <code>clinicalStatus</code> 'active' or
              ...
              <li>
                ...
                <ul>
                  <li>
                    CQL function: <code>C3F.Confirmed</code>
                  </li>
                  <li>
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>
                    Summary: Returns a list of conditions that occurred between now and the time period specified by the
                    user
                    <ul>
                      <li>
                        In FHIR R4, this returns conditions with <code>onset[x]</code> or <code>recordedDate</code> that
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <ul>
                      <li>
                        In FHIR R4, this sorts conditions using <code>onset[x]</code> and <code>recordedDate</code> and
                        returns the last condition from that list
                      </li>
                      <li>
                        In FHIR STU3, this sorts conditions using <code>onset[x]</code> and <code>assertedDate</code>{' '}
            ...
            <ul>
              <li>
                ...
                <ul>
                  ...
                  <li>
                    Summary: Returns a list of active devices. In FHIR, a device is considered "active" if it is
                    available for use. If it is an implanted device, this means it is implanted in the patient.
                    <ul>
                      <li>
            ...
            <ul>
              <li>
                ...
                <ul>
                  <li>
                    CQL function: <code>C3F.InProgress</code>
                  </li>
                  <li>
                    Summary: Returns a list of encounters with <code>status</code> 'in-progress'
                  </li>
            ...
            <ul>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <ul>
                      ...
                      <li>
                        In FHIR STU3, this returns immunizations with <code>status</code> of 'completed' and{' '}
                        <code>notGiven</code> is 'not true'
                      </li>
                      <li>
                        In FHIR DSTU2, this returns immunizations with <code>status</code> of 'completed' and{' '}
                        <code>wasNotGiven</code> is 'not true'
                      </li>
                    </ul>
                  </li>
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>
                    Summary: Returns a list of immunizations that occurred between now and the time period specified by
                    the user
                    <ul>
                      <li>
                        In FHIR R4, this returns immunizations with <code>occurrence[x]</code> that occurred within the
                        period
                      </li>
                      <li>
                        In FHIR STU3 and DSTU2, this returns immunizations with <code>date</code> that occurred within
                        the period
                      </li>
                    </ul>
                  </li>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <ul>
                      <li>
                        In FHIR R4, this sorts immunizations by <code>occurrence[x]</code> datetimes and returns the
                        last immunization from that list.
                      </li>
                      <li>
                        In FHIR STU3 and DSTU2, this sorts immunizations by <code>date</code> values and returns the
                        last immunization from that list.
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <ul>
                      <li>
                        In FHIR R4 and STU3, this returns a list of medication requests with <code>status</code>{' '}
                        'active'
                      </li>
                      <li>
                  ...
                  <li>Returns: List of Medication Requests or Medication Orders</li>
                </ul>
              </li>
              <li>
                Look Back
                <ul>
                  ...
                  <li>
                    ...
                    <ul>
                      <li>
                        In FHIR R4 and STU3, this returns a list of medication requests with <code>authoredOn</code>{' '}
                        that occurred within the period
                      </li>
                      <li>
            ...
            <ul>
              <li>
                ...
                <ul>
                  ...
                  <li>Returns: List of Medication Statements</li>
                </ul>
              </li>
              <li>
                Look Back
            ...
            <ul>
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>Returns: List of Observations</li>
                </ul>
              </li>
              <li>
                Most Recent
                <ul>
                  ...
                  <li>
                    ...
                    <code>effective[x]</code> and <code>issued</code> times and returns the last observation from that
                    list.
                  </li>
                  <li>Returns: Observation</li>
                </ul>
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <ul>
                      <li>
                        In FHIR R4 and STU3, this returns observations with with <code>status</code> of 'final,'
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>
                    Summary: Returns a list of observations with quantity values recorded in the unit specified by the
                    user
                    <ul>
                      <li>
                        In FHIR R4 and STU3, returns observations with <code>value.unit</code> or{' '}
                        <code>value.code</code> equal to the unit specified by the user
                      </li>
                      <li>
            ...
            <ul>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <ul>
                      ...
                      <li>
                        In FHIR DSTU2, this returns procedures with <code>status</code> of 'completed' and{' '}
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <ul>
                      ...
                      <li>
                        In FHIR DSTU2, this returns procedures with <code>status</code> of 'in-progress' and{' '}
                        <code>notPerformed</code> is 'not true'
                      </li>
                    </ul>
                  </li>
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>
                    Summary: Returns the most recent procedure from a list. Sorts procedures by{' '}
                    <code>performed[x]</code>
          ...
          <div className={styles.h3Wrapper}>
            ...
            <ul>
              <li>
                ...
                <ul>
                  <li>
                    CQL operator: <code>after</code>
                  </li>
                  <li>
                    Summary: Applies CQL operator <code>after</code> using the value specified by the user
                  </li>
                  <li>Returns: Boolean</li>
                </ul>
              </li>
              <li>
                ...
                <ul>
                  <li>
                    CQL operator: <code>before</code>
                  </li>
                  <li>
                    Summary: Applies CQL operator <code>before</code> using the value specified by the user
                  </li>
                  <li>Returns: Boolean</li>
                </ul>
              </li>
              <li>
                ...
                <ul>
                  <li>
                    CQL operator: <code>contains</code>
                  </li>
                  <li>
                    Summary: Applies CQL membership <code>contains</code> using the value specified by the user
                  </li>
                  <li>Returns: Boolean</li>
                </ul>
              </li>
          ...
          <div className={styles.h3Wrapper}>
            ...
            <ul>
              ...
              <li>
                ...
                <ul>
                  <li>
                    CQL operator: <code>not</code>
                  </li>
                  <li>
                    Summary: Negates the value of the current element. If the current value is <code>true</code>, this
                    will return <code>false</code>. If the current value is <code>false</code>, this will return{' '}
                    <code>true</code>.
                  </li>
                  <li>Returns: Boolean</li>
                </ul>
            ...
            <ul>
              <li>
                ...
                <ul>
                  ...
                  <li>
                    Summary: Compares the current decimal using the operator(s) and value(s) specified by the user.
            ...
            <ul>
              <li>
                ...
                <ul>
                  ...
                  <li>
                    Summary: Compares the current integer using the operator(s) and value(s) specified by the user.
                    Users can choose one or two operators and values to create a one or two sided comparison.
                  </li>
                  <li>Returns: Boolean</li>
                </ul>
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <ul>
                      <li>
                        In FHIR R4 and STU3, this returns the 'value' and 'unit' of an observation <code>value</code>
                      </li>
                      <li>
                        In FHIR DSTU2, this returns the 'value' and 'unit' of an observation <code>valueQuantity</code>
                      </li>
                    </ul>
                  </li>
                  <li>Returns: System Quantity</li>
            ...
            <ul>
              <li>
                ...
                <ul>
                  ...
                  <li>Summary: Checks if the current string ends with the string value specified by the user</li>
                  <li>Returns: Boolean</li>
                </ul>
              </li>
              <li>
                ...
                <ul>
                  ...
                  <li>
                    Summary: Checks if the current string is equal to the string value specified by the user using{' '}
                    <code>=</code>
                  </li>
                  <li>Returns: Boolean</li>
                </ul>
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>Summary: Checks if the current string starts with the string specified by the user</li>
                  <li>Returns: Boolean</li>
                </ul>
              </li>
              <li>
            ...
            <ul>
              <li>
                ...
                <ul>
                  ...
                  <li>
                    Summary: Choosing "value is a code from" checks if the current System Code is included in a valueset
                    specified by the user. Choosing "value is the code" checks if the current System Code is the same as
                    the code specified by the user.
                  </li>
                  <li>Returns: Boolean</li>
                </ul>
              </li>
            ...
            <ul>
              <li>
                ...
                <ul>
                  ...
                  <li>
                    Summary: Choosing "value is a code from" checks if the current System Concept is included in a
                    valueset specified by the user. Choosing "value is the code" checks if the current System Concept is
                    the same as the code specified by the user.
                  </li>
                  <li>Returns: Boolean</li>
                </ul>
              </li>
            ...
            <ul>
              <li>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <ul>
                      <li>
                        <code>Convert.to_mg_per_dL</code> converts the System Quantity value from mmol/L to mg/dL for
                        blood cholesterol and returns the converted quantity
                      </li>
                    </ul>
                  </li>
                  <li>Returns: System Quantity</li>
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>
                    Summary: Compares the current quantity using the operator(s), value(s), and unit specified by the
                    user. Users can choose one or two operators and values to create a one or two sided comparison.
                  </li>
                  <li>Returns: Boolean</li>
                </ul>
              </li>

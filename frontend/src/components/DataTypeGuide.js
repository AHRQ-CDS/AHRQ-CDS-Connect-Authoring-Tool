          ...
          <div className="userguide-guide">
            ...
            <div className="h2-wrapper">
              ...
              <ul>
                ...
                Look Back
                  <ul>
                    <li>CQL function: <code>C3F.ConditionLookBack</code></li>
                    <li>Summary: Returns a list of conditions that occurred between now and the time period specified by the user
                      <ul>
                        <li>
              ...
              <ul>
                ...
                <li>
                  ...
                  <ul>
                    ...
                    <li>
                      Summary: Returns a list of medications that are issued between now and the time period specified by the user
                      <ul>
                        <li>
                    ...
                    <li>
                      ...
                      <ul>
                        ...
                        <li>
                          ...
                          <code>wasNotTaken</code> is not true, and <code>end of EffectivePeriod</code> is 'null' or 'after Now()'
                        </li>
                      </ul>
                    </li>
                    <li>
                ...
                <li>
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      <ul>
                        <li>
                          In FHIR STU3, this returns procedures with <code>status</code> of 'in-progress' and <code>notDone</code>
                          is 'not true'
                        </li>
                        <li>
              ...
              <ul>
                <li>
                  ...
                  <ul>
                    ...
                    <li>
                      Summary: Applies <code>EndsWith</code> function to the current element with the value specified by the user
                    </li>
                    <li>
                      Returns: Boolean
                    </li>

...
import RecommendationWithSubpopulations from '../../documentation/userguide/screenshots/Recommendation_with_Subpopulations.png';
  ...
  <div className="userguide" id="maincontent">
    <div className="userguide-wrapper">
      <h1>CDS Authoring Tool User Guide</h1>
        ...
        <p><img alt="Authenticated Nav Bar" src={AuthenticatedNavBar} className="img-fluid img-thumbnail rounded mx-auto d-block"/></p>
        <ol>
        ...
        <p><img alt="Artifact Page" src={ArtifactList} className="img-fluid img-thumbnail rounded mx-auto d-block"/></p>
        <ol>
        ...
        <p><img alt="Collapsed Subpopulation" src={CollapsedSubpopulation} className="img-fluid img-thumbnail rounded mx-auto d-block"/></p>
        <ol>

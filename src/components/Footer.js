  ...
  render() {
    return (
      <div className="footer row">
        <div className="footer__ahrq col-12 col-md-3">
        ...
        <div className="footer__cds col-12 col-md-6">
        ...
        <div className="footer__contact col-12 col-md-3">
          <div className="footer__contact-hhs">
          ...
          <div className="footer__contact-ahrq">
        ...
        <div className="footer__sitelinks col-12 row">
          <div className="footer__sitelinks-ahrq col-1">
            <img src="/assets/images/ahrq-footer-logo.png" alt="footer logo" />
          </div>

          <div className="footer__sitelinks-links col-12 col-md-7">
          ...
          <div className="footer__sitelinks-social col-12 col-md-4">
            <span className="social-title">Get Social</span>

            <div className="addthis_horizontal_follow_toolbox social-links">

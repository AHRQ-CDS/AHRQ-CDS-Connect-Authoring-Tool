...
ArtifactRouter.route('/').get(artifact.allGet).post(artifact.singlePost).put(artifact.singlePut);

// Routes for /authoring/api/artifacts/:artifact
ArtifactRouter.route('/:artifact').get(artifact.singleGet).delete(artifact.singleDelete);

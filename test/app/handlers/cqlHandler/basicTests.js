...
describe('Subpopulation tests', () => {
  ...
  it('multiple recommendations and subpopulations', () => {
    let artifact = buildCQL(_.cloneDeep(raw));
    const converted = artifact.toString();
  ...
  it('second subpopulation is detected in a recommendation', () => {
    let with_one_rec = _.cloneDeep(raw);
    with_one_rec.recommendations.splice(1);
    let artifact = buildCQL(with_one_rec);
    const converted = artifact.toString();
  ...
  it('rationales', () => {
    let with_rationales = _.cloneDeep(raw);
    ...
    let artifact = buildCQL(with_rationales);
    const converted = artifact.toString();
  ...
  it('errors', () => {
    let with_errors = _.cloneDeep(raw);
    ...
    let artifact = buildCQL(with_errors);
    const converted = artifact.toString();
  ...
  it('subpopulations not used in recommendations do not include in population check.', () => {
    let no_recs = _.cloneDeep(raw);
    no_recs.recommendations = [];
    let artifact = buildCQL(no_recs);
    const converted = artifact.toString();
    // define "Subpopulation 1":
    //   if "InPopulation" is not true then
    //     null
